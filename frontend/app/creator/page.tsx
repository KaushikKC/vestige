          ...
          <div className="w-full max-w-lg relative">
            ...
            <div className="bg-white rounded-[32px] p-2 shadow-2xl border border-[#E6E8EF] relative z-10">
              <div className="p-6 pb-2 flex justify-between items-center">
                <h2 className="text-xl font-black text-[#09090A]">
                  Bridge to Privacy
                </h2>
              ...
              <div className="bg-[#F5F6FA] rounded-[24px] p-5 pt-8 mb-4 relative group hover:ring-1 hover:ring-[#1D04E1]/20 transition-all">
                <div className="flex justify-between text-xs font-bold text-[#6B7280] mb-3">
                  <span className="flex items-center gap-1">
                    <Lock size={12} className="text-[#1D04E1]" /> To Private
                    (Vestige)
                  </span>
                ...
                <div className="text-xs font-medium text-[#6B7280] mt-1">
                  ~$1,442.75{" "}
                  <span className="text-[#1D04E1] ml-2 font-bold">
                    (-0.5% fee)
                  </span>
                </div>
              </div>
              ...
              <div className="text-center mt-4 mb-2">
                <span className="text-[10px] text-[#B19DDC] font-bold uppercase tracking-widest bg-[#F5F6FA] px-3 py-1 rounded-full">
                  Powered by ZK-Tech
                </span>
              </div>
            </div>
